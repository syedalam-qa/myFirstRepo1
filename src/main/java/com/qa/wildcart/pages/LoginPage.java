...
public class LoginPage extends BasePage {
	...
	@Step("Getting the login page title") //Allure annotations
	...
	@Step("confirming signup button exists") //Allure annotations
	...
	@Step("login with username: {0} and password: {1}") //Allure annotations
